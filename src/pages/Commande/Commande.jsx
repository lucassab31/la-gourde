            ...
            <div className="col-md-7">
                ...
                <form action="/recap" method="post">
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="name" placeholder="Jean Dupont" required />
                    </div>
                    <div className="mb-3">
                        <label htmlFor="cardNumber" className="form-label">Numéro de carte</label>
                        <input type="text" onKeyDown={changeCardNumber} maxLength={19} className="form-control" id="cardNumber" placeholder="0000 0000 0000 0000" required />
                    </div>
                    <div className="row">
                        <div className="col-md-6">
                            <div className="mb-3">
                                <label htmlFor="cardDate" className="form-label">Date d'expiration</label>
                                <input type="text" pattern="[0-9]{2}/[0-9]{2}" onKeyDown={changeCardDate} maxLength={5} className="form-control" id="cardDate" placeholder="MM/YY" required />
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="mb-3">
                                <label htmlFor="cardCVC" className="form-label">CVC/CVV</label>
                                <input type="password" maxLength={3} className="form-control" id="cardCVC" placeholder="000" required />
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" className="btn btn-primary w-100 mt-2 text-white fw-bold btn-lg">Payer</button>
