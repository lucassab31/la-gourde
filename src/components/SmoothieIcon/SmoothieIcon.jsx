const SmoothieIcon = (props) => {
    ...
    return (
        <svg version="1.1" id="Food_Icons" width="100%" viewBox="0 0 56.205 85.403" enableBackground="new 0 0 56.205 85.403">
            <g id="_x35_">
                <g>
                ...
                <g>
                    <path fill={color} d="M5.513,39.143l2.71,36.605c0.28,4.422,3.949,7.866,8.38,7.866h22.995c4.432,0,8.1-3.444,8.38-7.867
                ...
                <g>
                    <path fill={colorDark} d="M34.582,74.547h0.961c1.944,0,3.519-1.576,3.519-3.519v-0.961c0-1.944-1.576-3.519-3.519-3.519h-0.961
                        c-1.944,0-3.519,1.576-3.519,3.519v0.961C31.063,72.971,32.638,74.547,34.582,74.547z"/>
                </g>
                <g>
                    <path fill={colorDark} d="M19.488,62.372h0.961c1.944,0,3.519-1.576,3.519-3.519v-0.961c0-1.944-1.576-3.519-3.519-3.519h-0.961
                        c-1.944,0-3.519,1.576-3.519,3.519v0.961C15.969,60.797,17.545,62.372,19.488,62.372z"/>
                </g>
                <g>
                    <path fill={colorDark} d="M36.582,53.122h0.961c1.944,0,3.519-1.576,3.519-3.519v-0.961c0-1.944-1.576-3.519-3.519-3.519h-0.961
